...
set('#originalcodeblock', { x: 25, y: 15, scale: 0 });
const CODEPEN = document.querySelector('.animecodingcodepen');
const TL = timeline({
  yoyo: true,
  repeat: -1,
  onStart: () => {
    // We want to fire a code block here!
    const block = document.querySelector('#originalcodeblock').cloneNode(true);
